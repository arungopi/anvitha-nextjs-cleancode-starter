/**
 * @file MuiLoginForm.tsx
 * @description  Login form using MUI components
 ...
 * TODO: https://mui.com/toolpad/core/react-sign-in-page/
 * 
 */
...
const handleSubmitForm = (data: { email: string, password: string }) => {
    ...
    }, { redirectTo: "/dashboard" }); // redirected to dashboard after signin
}
            ...
            <Container maxWidth="sm">
                <Box component="form" onSubmit={handleSubmit(handleSubmitForm)} sx={{
                    ...
                    <Typography variant="subtitle1" gutterBottom>
                        Tooling for Language computing
                    </Typography>
